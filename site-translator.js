(function () {
  ...
  const exactEnglish = {
    ...
    '🌳 AAA RODRIGUEZ GENERAL SERVICES 🌳': '🌳 AAA RODRIGUEZ GENERAL SERVICES 🌳',
    '🌿 ¡CUIDAMOS Y EMBELLECEMOS SU HOGAR! 🏡': '🌿 WE CARE FOR AND BEAUTIFY YOUR HOME! 🏡',
    '¿Tiene árboles demasiado grandes, ramas peligrosas o árboles cerca de su techo? 🌳⚠️': 'Do you have oversized trees, dangerous branches, or trees near your roof? 🌳⚠️',
    '✅ Corte y poda de árboles': '✅ Tree cutting and trimming',
    '✅ Eliminación de ramas peligrosas': '✅ Removal of dangerous branches',
    '✅ Limpieza de árboles y propiedades': '✅ Tree and property cleanup',
    '✅ Removemos árboles que representen un peligro': '✅ We remove trees that represent a danger',
    '✅ Protección y seguridad alrededor de su hogar': '✅ Protection and safety around your home',
    ...
    '📞 AAA RODRIGUEZ GENERAL SERVICE': '📞 AAA RODRIGUEZ GENERAL SERVICE',
